...
client = MongoClient("mongodb+srv://goitlearn:WAdWzy6PycdDlgm7@cluster0.utwip5n.mongodb.net/myDB1?retryWrites=true&w=majority")
...
def convert_date_format(date_str):
    try:
        # Assuming the MongoDB date format is "Month Day, Year" (e.g., "March 14, 1879")
...
for mongo_author in mongo_authors.find():
    ...
    born_date = convert_date_format(mongo_author['born_date'])
